...
We request the absolute beginners to skip this skipper part and go to [What is Raspberry PI](https://github.com/SyedSahil80328/NavAid#what-is-raspberry-pi).
...
[Steps for running our project.](https://github.com/SyedSahil80328/NavAid#installing-neccessary-modules)

Note: If you haven't enabled the camera option (without enabling it makes our program to fail) though you have [upgraded the PI](https://github.com/SyedSahil80328/NavAid#upgrading-the-pi) (Click if you haven't upgraded it yet) please [don't skip it](https://github.com/SyedSahil80328/NavAid#enabling-camera-option).
...
<p float="left">
<img src="Manual%20Pictures/pi-imager.png" width="45%">
<img src="Manual%20Pictures/SSH-Save.png" width="45%">
</p>
...
![Login through SSH](Manual%20Pictures/login-SSH.png)
...
![Figure 4: Raspi Config Interface](Manual%20Pictures/raspi-config.png)
<p align="center"><i>Figure 4: Raspi Config Interface</i></p>

Then select VNC (Figure 5).

<img src="Manual%20Pictures/config-interface.png">
...
<p align="center"><img src="Manual%20Pictures/VNC-new.png" width="75%"></p>
...
<p align="center"><img src="Manual%20Pictures/VNC-credentials.png" width="75%"></p>
...
<p align="center"><img src="Manual%20Pictures/VNC-new-user.png" width="75%"></p>
<p align="center"><i>Figure 11: New device creation</i></p>

<p float="left">
<img src="Manual%20Pictures/VNC-first-time.png" width="45%">
<img src="Manual%20Pictures/VNC-login.png" width="45%">
</p>
...
<img src="Manual%20Pictures/VNC-success-output.png">
...
<img src="Manual%20Pictures/raspi-config.png">
...
<p>It requires rebooting, so issue the command given for <a href="https://github.com/SyedSahil80328/NavAid?tab=readme-ov-file#upgrading-the-pi" >rebooting</a>.</p>
...
mv NavAid.git blindhelper
```
<p>We are renaming the repo name as the internal system uses the renamed repo name. You can give your own name. But recommended to keep the name as it is.</p>
